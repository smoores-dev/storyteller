...
internal class MetadataParser(
    ...
    private fun parseLinkElement(element: ElementNode, filePath: Url): MetadataItem.Link? {
        ...
        val rel =
            parseProperties(relAttr).map { resolveProperty(it, prefixMap, DEFAULT_VOCAB.LINK) }
    ...
    private fun contributorWithLegacyAttr(
        element: ElementNode,
        name: String,
        value: String
    ): MetadataItem.Meta {
    ...
    private fun dateWithLegacyAttr(
        element: ElementNode,
        name: String,
        value: String
    ): MetadataItem.Meta {
    ...
    private fun resolveItemsHierarchy(items: List<MetadataItem>): List<MetadataItem> {
        ...
        val exprByRefines =
            items.groupBy(MetadataItem::refines) as Map<String, List<MetadataItem.Meta>>
