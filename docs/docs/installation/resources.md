...
| GPU       | NVIDIA (CUDA 11.8, 12.x, 13.x), newer AMD GPUs (RDNA 2, RDNA 3), Intel Arc GPUs, or Intel iGPUs | A GPU is _not_ required to run Storyteller. See [the docs on GPU acceleration](installation/gpu-configuration.mdx)                                                                                               |
